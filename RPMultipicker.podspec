#
#  Be sure to run `pod spec lint RPMultipicker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "WhatsApp like image picker."
  ...
  s.author             = { "Matijas Milos" => "matijas.milos@gmx.de" }
  # Or just: s.author    = "Matijas Milos"
  # s.authors            = { "Matijas Milos" => "matijas.milos@gmx.de" }
  # s.social_media_url   = "http://twitter.com/Matijas Milos"
